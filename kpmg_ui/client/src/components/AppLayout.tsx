...
import { Moon, Sun, User, LogOut, MessageSquare, FileSearch, Settings, TestTube, Scale, Library, ShieldCheck } from "lucide-react";
...
const tabs = [
  ...
  { title: "Controls Library", path: "/controls-library", icon: ShieldCheck },
