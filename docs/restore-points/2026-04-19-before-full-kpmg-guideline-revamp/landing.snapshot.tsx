        ...
        <div className="relative z-10 mx-auto flex w-full max-w-[1400px] items-center justify-between px-8 py-4 lg:px-14">
          ...
          <div className="flex items-center gap-2">
            <Button
              variant="ghost"
              size="sm"
              className="rounded-full text-white/86 hover:bg-white/10 hover:text-white text-xs gap-1.5"
        ...
        <div className="relative z-10 mx-auto grid w-full max-w-[1400px] gap-10 px-8 pb-18 pt-10 lg:grid-cols-[minmax(0,1.6fr)_380px] lg:px-14 lg:pb-20">
          <div>
            <div className="mb-5 inline-flex items-center gap-2 rounded-full border border-white/14 bg-white/8 px-3 py-1.5">
              ...
              <span className="text-[10px] font-bold uppercase tracking-[0.28em] text-white/88">Single-entry point</span>
            </div>
            ...
            <p className="mt-6 max-w-2xl text-[15px] leading-7 text-white/78">
            ...
            <p className="mt-8 text-[12px] font-semibold uppercase tracking-[0.22em] text-white/64">
