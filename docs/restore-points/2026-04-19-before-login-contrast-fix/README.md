# Before Login Contrast Fix Restore Point

This restore point captures the login page state before the dark-on-dark contrast correction created on `2026-04-19`.
...
```powershell
$restoreDir = "docs/restore-points/2026-04-19-before-login-contrast-fix"
