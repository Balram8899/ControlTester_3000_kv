# Login Globe Pass Restore Point

This restore point captures the KPMG-style login screen update created on `2026-04-19`.
...
```powershell
$restoreDir = "docs/restore-points/2026-04-19-login-globe-pass"
