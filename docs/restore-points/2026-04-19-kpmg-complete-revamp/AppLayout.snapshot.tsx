      ...
      >
        ...
        >
          <div className={`flex items-center transition-all duration-300 ${collapsed ? "justify-center" : "gap-3 pr-10"}`}>
            ...
            {!collapsed && (
              <div className="min-w-0">
                <p className="text-[9px] font-bold uppercase tracking-[0.32em] text-white/46">KPMG TRACE</p>
                <p className="mt-1 text-[13px] font-semibold text-white">Control Workspace</p>
                <p className="text-[10px] leading-4 text-white/48">Assessment, testing, and reporting</p>
              </div>
            )}
          </div>
          ...
          <button
            ...
            className="absolute right-3 top-1/2 flex h-8 w-8 -translate-y-1/2 items-center justify-center rounded-full border border-white/12 bg-white/8 text-white/55 hover:text-white hover:bg-white/14 transition-colors flex-shrink-0"
          >
