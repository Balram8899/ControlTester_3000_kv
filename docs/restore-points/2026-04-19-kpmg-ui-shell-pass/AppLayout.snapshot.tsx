...
export default function AppLayout({ children }: AppLayoutProps) {
  ...
  return (
    <div className="kpmg-shell flex h-screen bg-background">
      ...
      >
        <div
          className="relative flex h-20 items-center border-b border-border flex-shrink-0"
          style={{
        ...
        >
          ...
          >
            <img src={logo} alt="TRACE logo" className="h-8 w-auto object-contain flex-shrink-0 brightness-0 invert" />
            <div className="min-w-0">
              <p className="text-[11px] font-bold uppercase tracking-[0.3em] text-white">TRACE</p>
              <p className="text-[10px] leading-4 text-white/42">Control Testing Platform</p>
            </div>
          </div>
          ...
          <button
            ...
            className="h-7 w-7 flex items-center justify-center rounded-full border border-white/12 bg-white/8 text-white/50 hover:text-white hover:bg-white/14 transition-colors flex-shrink-0"
          >
              ...
              const button = (
                <button
                  ...
                  className={`kpmg-sidebar-link w-full flex items-center rounded-xl text-sm font-medium transition-all duration-150 ${
                    ...
                    comingSoon
                      ? "opacity-30 cursor-not-allowed border-l-[3px] border-transparent text-white/35"
                      : isActive
                        ? "text-[#00B8F5] bg-[rgba(0,184,245,0.13)] border-l-[3px] border-[#00B8F5]"
                        : "text-white/52 hover:bg-white/7 hover:text-white/88 border-l-[3px] border-transparent"
                  }`}
                >
        ...
        <div className="border-t border-white/8 flex-shrink-0" style={{ padding: collapsed ? "10px 4px" : "10px 8px" }}>
          {collapsed ? (
            ...
            <div className="flex items-center gap-2.5 px-3 py-2.5 rounded-xl bg-white/6 overflow-hidden">
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-[10px] text-white/38 leading-none">Analyst</p>
              </div>
            </div>
          )}
        </div>
        ...
        <header className="kpmg-shell-header h-16 flex items-center px-4 gap-2 flex-shrink-0 sticky top-0 z-50 border-b border-white/10">
          <div className="flex items-center gap-2.5">
            ...
            <div className="flex flex-col leading-none">
              ...
              <span className="text-[9px] text-white/55 tracking-[0.18em] uppercase mt-0.5">Control Testing Platform</span>
            </div>
          </div>
          <div className="flex-1" />
          <div className="flex items-center gap-2">
            <span className="hidden sm:inline-flex items-center gap-1.5 text-[11px] font-medium text-[var(--green)] bg-[rgba(0,154,68,0.12)] px-2.5 py-1 rounded-full">
