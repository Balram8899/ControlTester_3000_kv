...
const HERO_SUMMARY = [
  {
    ...
    description: "Assessment, testing, reporting, and remediation modules retained.",
  },
  {
    label: "Library-led operations",
    value: "3",
    description: "Regulatory, controls, and frameworks libraries anchor comparison and analysis flows.",
  },
  {
    label: "Core delivery tracks",
    value: "4",
    description: "Comparison, control testing, evidence assessment, and reporting operate as linked workflows.",
  },
];
    ...
    <div className="landing-shell flex min-h-screen flex-col" style={{ fontFamily: "Arial, sans-serif" }}>
      ...
      <header className="landing-hero relative overflow-hidden">
        ...
        <div className="relative z-10 mx-auto flex w-full max-w-[1320px] items-center justify-between px-8 py-4 lg:px-12">
          <div className="flex items-center gap-4">
            <img src={logo} alt="KPMG" className="h-8 w-auto object-contain brightness-0 invert" />
            <div className="hidden h-7 w-px bg-white/14 sm:block" />
            <div className="hidden sm:block">
              <p className="text-[11px] font-bold uppercase tracking-[0.34em] text-white leading-none">TRACE</p>
              <p className="text-[10px] text-white/52 mt-0.5">Control Testing Platform</p>
            </div>
          </div>
          <div className="flex items-center gap-2">
            ...
            <Button
              variant="ghost"
              size="sm"
              className="rounded-full text-white/65 hover:bg-white/10 hover:text-white text-xs gap-1.5"
        ...
        {/* Hero content */}
        <div className="relative z-10 mx-auto grid w-full max-w-[1320px] gap-8 px-8 pb-16 pt-8 lg:grid-cols-[minmax(0,1.5fr)_340px] lg:px-12 lg:pb-18 lg:pt-10">
          <div>
            <div className="mb-5 inline-flex items-center gap-2 rounded-full border border-white/14 bg-white/8 px-3 py-1.5">
              ...
              <span className="text-[10px] font-bold uppercase tracking-[0.28em] text-white/70">Control environment workspace</span>
            </div>
            <h1 className="max-w-2xl text-4xl font-bold leading-[1.08] tracking-[-0.01em] text-white sm:text-[44px]">
              Central operating point for TRACE assessment, testing, and reporting workflows.
            </h1>
            <p className="mt-5 max-w-xl text-[14px] leading-7 text-white/65">
              Access regulatory ingestion, RCM and regulation comparison, control diagnostics, evidence assessment,
              risk assessment, issue management, and reporting from a single platform catalogue.
            </p>
          ...
          <aside className="kpmg-summary-panel rounded-[24px] p-6 text-white self-start mt-2">
            ...
            <div className="mt-5 space-y-0">
              {HERO_SUMMARY.map((item, index) => (
                <div
                  key={item.label}
                  className={`py-4 ${index > 0 ? "kpmg-summary-stat" : ""}`}
                >
      ...
      <main className="flex-1 px-8 py-10 lg:px-12 lg:py-12">
        <div className="mx-auto max-w-[1320px] space-y-8">
          ...
          {/* Section header */}
          <div className="dashboard-band rounded-[20px] px-7 py-5">
            <div className="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
              <div>
                <p className="kpmg-section-label text-[#1E49E2]">Workspace catalogue</p>
                <h2 className="mt-2 text-[22px] font-bold text-[#0C233C]">
                  Platform capabilities and operating modules
                </h2>
                <p className="mt-1.5 max-w-2xl text-[13px] leading-6 text-slate-500">
                  Each card below opens a retained module and describes the primary techno-functional role
                  it plays in the TRACE operating model.
                </p>
              </div>
              <div className="flex flex-wrap gap-2.5 flex-shrink-0">
                <span className="landing-chip rounded-full px-3.5 py-1.5 text-[11px] font-bold tracking-[0.12em] uppercase">
                  {FEATURE_CARDS.length} workspaces
                </span>
                <span className="landing-chip rounded-full px-3.5 py-1.5 text-[11px] font-bold tracking-[0.12em] uppercase">
            ...
            {FEATURE_CARDS.map((feature, idx) => {
              ...
              return (
                ...
                >
                  ...
                  <div className="flex items-start justify-between gap-4">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <h3 className="mt-1 text-[17px] font-bold text-[#0C233C] leading-tight">{feature.title}</h3>
                      </div>
                    </div>
                    <span
                  ...
                  {/* Description */}
                  <p className="mt-4 flex-1 text-[13px] leading-[1.65] text-slate-500">
                    {feature.description}
                  </p>

                  {/* Footer */}
                  <div className="mt-5 flex items-center justify-between border-t border-[#00338D]/8 pt-4">
                    <span className="text-[11px] font-bold uppercase tracking-[0.2em] text-[#00338D]">
                      Open workspace
                    </span>
                    <div
